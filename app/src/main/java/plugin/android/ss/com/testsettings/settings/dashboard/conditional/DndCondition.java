 ...
 */
package plugin.android.ss.com.testsettings.settings.dashboard.conditional;
...
public class DndCondition extends Condition {
    ...
    public void refreshState() {
        ...
        boolean zenModeEnabled = mZen != Global.ZEN_MODE_OFF;
        if (zenModeEnabled) {
    ...
    public void onActionClick(int index) {
        if (index == 0) {
            ...
            notificationManager.setZenMode(Global.ZEN_MODE_OFF, null, TAG);
            setActive(false);
        } else {
