...
package plugin.android.ss.com.testsettings.settings.location;
 ...
 * android.content.pm.RegisteredServicesCache#parseServiceAttributes(Resources,
 * String, AttributeSet)} into an interface, which didn't seem worth it.
 */
