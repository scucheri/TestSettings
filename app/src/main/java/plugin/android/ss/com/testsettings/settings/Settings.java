...
package plugin.android.ss.com.testsettings.settings;
...
public class Settings extends SettingsActivity {
    ...
    */
	...
	super.onResume();
	if(sp == null)
	 sp = Settings.this.getSharedPreferences("SP", MODE_PRIVATE);

	if(editor == null)
		editor = sp.edit();

           currLanug = getResources().getConfiguration().locale.getCountry();
	   if(sp.getString("currLanug", null)==null){
	        editor.putString("currLanug", currLanug);
		editor.commit();
		return;
	}

	if(!sp.getString("currLanug", null).equals(currLanug)){
	   editor.clear();
	   editor.putString("currLanug", currLanug);
	   editor.commit();
	 finish();
    ...
    public static class ProcessStatsSummaryActivity extends SettingsActivity { /* empty */ }
