...
package plugin.android.ss.com.testsettings.settings.fuelgauge;
...
public class PowerUsageSummary extends PowerUsageBase implements OnLongClickListener,
    ...
    private LoaderCallbacks<List<BatteryTip>> mBatteryTipsCallbacks =
            new LoaderCallbacks<List<BatteryTip>>() {
