...
package plugin.android.ss.com.testsettings.settings.deviceinfo.aboutphone;

import static com.android.settings.bluetooth.Utils.getLocalBtManager;
import com.android.settings.deviceinfo.StartWizardPreferenceController;
import com.android.settings.deviceinfo.HDCPPreferenceController;
import com.android.settings.deviceinfo.WidevinePreferenceController;
...
public class MyDeviceInfoFragment extends DashboardFragment
	...
	controllers.add(new StartWizardPreferenceController(context , fragment));
       controllers.add(new HDCPPreferenceController(context));
       controllers.add(new WidevinePreferenceController(context));
