...
package plugin.android.ss.com.testsettings.settings.widget;
...
public class SettingsAppWidgetProvider extends AppWidgetProvider {
    ...
    private static final class LocationStateTracker extends StateTracker {
        private int mCurrentLocationMode = Secure.LOCATION_MODE_OFF;
        ...
        public int getActualState(Context context) {
            ...
            mCurrentLocationMode = Secure.getInt(resolver,
                    Secure.LOCATION_MODE, Secure.LOCATION_MODE_OFF);
            return (mCurrentLocationMode == Secure.LOCATION_MODE_OFF)
