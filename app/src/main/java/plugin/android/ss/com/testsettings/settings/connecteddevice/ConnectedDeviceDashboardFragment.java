 ...
 */
package plugin.android.ss.com.testsettings.settings.connecteddevice;
...
public class ConnectedDeviceDashboardFragment extends DashboardFragment {
    ...
    private static List<AbstractPreferenceController> buildPreferenceControllers(Context context,
	 ...
	 final BluetoothMasterSwitchPreferenceController bluetoothPreferenceController =
	                 new BluetoothMasterSwitchPreferenceController(context, Utils.getLocalBtManager(context),metricsFeatureProvider);
    ...
    public static final SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider() {
                ...
                public List<AbstractPreferenceController> createPreferenceControllers(Context
                        context) {
                    return buildPreferenceControllers(context, null /* lifecycle */,null);
                }
